...
#     if not video_id:
#         logging.warning("Invalid YouTube URL: %s", youtube_url)
#         return None, None
...
#         logging.error("Error fetching YouTube metadata: %s", e)
#         return None, None

# def process_generated_titles(response: str) -> list:
#     """Cleans and processes AI-generated titles."""
#     if not response:
#         logging.warning("Empty response from AI model")
#         return []
...
#     if not titles:
#         logging.warning("No valid titles extracted from AI response: %s", response)
...
#     logging.info(f"Successfully generated and stored titles for: {user_input}")
